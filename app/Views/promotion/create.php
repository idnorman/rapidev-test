...
<div class="container mt-4 d-flex justify-content-center">
	<div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 col-xs-12">
      ...
      <?php endif;?>
	   <form method="POST" action="<?= url_to('promotion_store') ?>">
	    	<div class="mb-3">
	        	<label for="name" class="form-label">Judul Promo</label>
	        	<input type="text" class="form-control" id="name" name="name" placeholder="Promo Kemerdekaan">
	    	</div>
	    	<div class="mb-3">
	    		<label>Jenis Promo</label>
		    	<div class="form-check">
				  	<input class="form-check-input" type="radio" name="type" id="type1" value="DISCOUNT" checked>
				  	<label class="form-check-label" for="type1">
				   	Diskon
				  	</label>
				</div>
				<div class="form-check">
				  	<input class="form-check-input" type="radio" name="type" id="type2" value="CASHBACK">
			...
			<div class="input-group mb-3">
			  <input type="number" step="any" min="0" max="100" name="amount" class="form-control" id="amount" aria-describedby="amount-addon3" placeholder="20">
			...
			<div class="input-group mb-3">
			  ...
			  <input type="text" name="max_amount" class="form-control" id="max_amount" aria-describedby="max_amount-addon3" placeholder="20000">
			</div>
	    	<div class="mb-3">
	        		...
	        		<?php foreach($hotels as $hotel): ?>
	        			...
	        			<?php foreach($rooms as $room): ?>
	        				<?php if($hotel['id'] == $room['property_id']): ?>
	        					<option class="room" value="<?= $hotel['id'] ?>-<?= $room['id'] ?>"><?= $room['name'] ?></option>
	        				<?php endif ?>
	        			<?php endforeach ?>
	        			</optgroup>
	        		<?php endforeach ?>
